...
// Returns the system information (OS, memory, platform) as an HTML string.
...
// Returns the disk usage information as an HTML string.
...
// Returns the CPU information as an HTML string, including model name and core usage percentages.
